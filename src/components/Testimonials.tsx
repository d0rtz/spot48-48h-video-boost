    ...
    <section id="testimonials" className="py-24 bg-background">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Casos de éxito</h2>
          <p className="text-xl text-muted-foreground">Lo que dicen nuestros clientes sobre los resultados</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="p-6 shadow-elegant bg-gradient-subtle border-primary/10">
              ...
              <blockquote className="text-lg font-medium text-foreground mb-4">"{testimonial.text}"</blockquote>
